...
- [x] CITATION.cff exists and includes the Zenodo DOI.
- [x] LICENSE exists.
- [x] data/ contains material coefficients and shareable input assumptions.
- [x] results/ contains the 80-case matrix and sensitivity outputs.
...
- [x] GitHub release v1.0.1-submission exists.
